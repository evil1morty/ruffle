...
file-menu = Fichier
file-menu-open-file = Ouvrir Fichier...
file-menu-open-directory = Ouvrir Dossier...
file-menu-open-advanced = Ouvrir avec options...
file-menu-close = Fermer
file-menu-reload = Recharger
file-menu-recents = Fichiers récents
...
bookmarks-menu = Favoris
bookmarks-menu-add = Ajouter...
